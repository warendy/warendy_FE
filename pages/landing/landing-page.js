      ...
      <div className={styles.center}>
        ...
        <div className={styles.resultCotnainer}>
          <div className={styles.resultAnimal}>
            <Image src="/images/otter.svg" alt="Logo" className={styles.img} width={40} height={40} />
          </div>
          <h2 className={styles.resultTitle}>혼자 있는 걸 좋아하는 고독한 당신</h2>
          <div className={styles.resultContent}>
            ...
            <div className={styles.resultExplain}>
              <h2 className={styles.resultTitleOne}>
                깊은 풍미의 레드와인으로 분위기를 잡아보는 건 어떠신가요? <br /> 짙은 과육이 당신의 스트레스를 천천히 녹여줄거에요.
              </h2>
