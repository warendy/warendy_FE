      ...
      (async () => {
        try {
          ...
          if (likesCount === 3) {
            ...
            filteredWines = wineData.filter(
              (wine) => wine.body <= 2 && wine.dry <= 2 && wine.tannin <= 2
            );
          } else {
  ...
  return (
    <div className={styles.haus}>
      <figure
        ...
        style={{ display: buttonClickCount >= 4 ? "none" : "flex" }}
      >
          ...
          >
            ...
            >
              ...
              <div
                ...
                onClick={() => handleOptionClick("soSo")}
              >
                그냥 그래.
              </div>
              <div
                className={styles.disLike}
                onClick={() => handleOptionClick("dislike")}
              >
                난 별로야!
              </div>
            </div>
      ...
      <div
        ...
        style={{ display: buttonClickCount >= 4 ? "flex" : "none" }}
      >
        ...
        <div className={styles.resultContent}>
          <div className={styles.resultWine}>
            {recommendedWine &&
              recommendedWine.length > 0 &&
              recommendedWine[0].picture && (
                <Image
                  src={recommendedWine[0].picture}
                  alt="Recommended Wine 1"
                  className={styles.img}
                  width={40}
                  height={40}
                />
          ...
          <div className={styles.resultWine}>
            {recommendedWine &&
              recommendedWine.length > 1 &&
              recommendedWine[1].picture && (
                <Image
                  src={recommendedWine[1].picture}
                  alt="Recommended Wine 2"
                  className={styles.img}
                  width={40}
                  height={40}
                />
        ...
        <div
          ...
          style={{ display: buttonClickCount >= 3 ? "flex" : "none" }}
        >
        ...
        <div
          className={styles.suggestionCotnainer}
          style={{ display: showSuggestion ? "flex" : "none" }}
        >
      ...
      <div
        ...
        style={{ display: buttonClickCount >= 4 ? "none" : "block" }}
      >
