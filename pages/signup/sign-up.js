          ...
          <div className={styles.contentArea + " inner "}>
            <div className={styles.inputInfo}>
              <div className={styles.email}>
                ...
                <div>
                  <div className={styles.inputArea}>
                    <input type="email" placeholder="예) waren@warendy.com" className={styles.input + " input "} autoComplete="off" />
                  </div>
              ...
              <div className={styles.password}>
                ...
                <div>
                  <div className={styles.inputArea}>
                    <input type="password" placeholder="영문, 숫자, 특수문자 조합 8-16자" className={styles.input + " input "} autoComplete="off" />
                  </div>
                </div>
                <p className={styles.error}>영문, 숫자, 특수문자를 조합해서 입력해주세요.</p>
              </div>
