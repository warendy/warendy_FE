    ...
    <>
      <div className="container">
        <div className="inner padding">
          <Image src="/images/logo.svg" alt="Logo" className={styles.logo} width={250} height={50} />
          <div className={styles.contentArea + " inner "}>
            <div className={styles.inputInfo}>
              <div className={styles.email}>
                ...
                <div>
                  <div className={styles.inputArea}>
                    <input type="email" placeholder="예) ozik@ozik.co.kr" className={styles.input + " input "} autoComplete="off" />
              ...
              <div className={styles.password}>
                ...
                <p className={styles.error}>영문, 숫자, 특수문자를 조합해서 입력해주세요. (8-16자) </p>
              </div>
              <div className={styles.btnArea}>
                ...
                <button className={styles.btnSocial + " btn "}>
                  <Image src="/images/kakao.svg" alt="Logo" className={styles.social} width={30} height={30} />
