...
import { faMapMarkerAlt, faSearch, faPaste } from "@fortawesome/free-solid-svg-icons";
        ...
        <header className={styles.header}>
          <div className="inner">
            <div className={styles.headerTop}>
              ...
              {userToken ? (
                <button onClick={handleLogout} className={styles.link + " resetBtn "}>
                  로그아웃
                </button>
              ) : (
            ...
            <div className={styles.headerMain}>
              <div className={styles.mainInner}>
                <h1 className={styles.mainLogo}>
                  <Link href="/main/main" className={styles.logo}>
                ...
                <div className={styles.gnbArea}>
                  <nav className={styles.gnb}>
                    ...
                    <Link href="../post/post" className={`${styles.gnbItem} ${styles.link}`}>
                      <FontAwesomeIcon icon={faPaste} className={styles.icon} />
                    </Link>
                  </nav>
                  <div className={styles.searchBtnBox}>
                    <Link href="#" className={`${styles.btnSearch} ${styles.link}`} onClick={changeState}>
